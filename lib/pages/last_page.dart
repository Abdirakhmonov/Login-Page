      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(icon: Icon(Icons.home_outlined, color: Colors.grey,),
              label: "Home",),
          BottomNavigationBarItem(icon: Icon(Icons.edit, color: Colors.grey,),
              label: "Schedule"),
          BottomNavigationBarItem(icon: Icon(Icons.calendar_month, color: Colors.grey,),
              label: "Calendar"),
          BottomNavigationBarItem(icon: Icon(CupertinoIcons.person, color: Colors.grey,),
              label: "Profile"),
        ],
      ),
    );
